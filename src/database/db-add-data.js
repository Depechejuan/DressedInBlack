...
async function addData(pool) {
    ...
    await pool.query(
        ...
        [
            ...
            true,
            "2",
            "1O_SDEUqqE0guakDqkRCQ9f-aGxP593dq",
            "Alicante",
    ...
    await pool.query(
        ...
        [
            ...
            true,
            "1",
            "10HjoQ5wrtBs0x0Ks-JpKBKdS0_q_jJNp",
            "Elda",
    ...
    await pool.query(
        ...
        [
            ...
            true,
            "4",
            "1cnhVjGBaMxTX7zYghg1OUefyzlXz7hi1",
            "Valencia",
    ...
    await pool.query(
        ...
        [
            ...
            true,
            "3",
            "1a2A7VPiI7aBWFoKlYUyOCFmjRUcVO2Mn",
            "Valencia",
    ...
    await pool.query(
        ...
        [
            ...
            true,
            "5",
            "1EiSTYsTWpQX-JFvQlXY27LdiKUJGR9fB",
            "Elche",
